    ...
    >
      ...
      >
        {contentData.testimonials.map((testimonial, index)=> (
            ...
            <div className={`w-full shadow-md h-[22rem]  bg-no-repeat bg-cover bg-center rounded-lg relative overflow-hidden ${testimonial.coverinvitation}`}>
              <div className="absolute w-full h-fit bg-[#f3f4f6] bottom-0 flex flex-col items-center p-3">
                <div className="flex w-full h-fit justify-between items-center">
                  <span className="flex items-center">
                    <VscAccount className="text-3xl" />
                    <h2 className="font-semibold ml-2">{testimonial.username}</h2>
                  </span>
