...
const register = () => {
  ...
  return (
    <section className="w-full min-h-screen bg-[#E0F6FC]">
      ...
      <div className="w-10/12 mx-auto max-sm:w-full max-sm:rounded-none h-screen rounded-full bg-[#d4f3fb] flex justify-center items-center ">
        <form className="max-w-[450px] w-full h-fit bg-white shadow-[0px_0px_3px_rgba(0,0,0,.25)] py-7 px-4 rounded-xl relative max-sm:w-11/12">
          ...
          <label className="w-10/12 mx-auto flex flex-col mt-4 max-sm:w-11/12">
          ...
          <button
            type="submit"
            className="bg-[#8758ff] text-white text-lg flex mx-auto items-center justify-center max-sm:w-11/12 w-10/12 mt-10 rounded-full py-1 "
          >
            Daftar
          </button>
          <span className="flex w-10/12 mx-auto justify-center mt-4">
            <p>Sudah memiliki akun?</p>
            <a href="/auth/login" className="text-[#8758ff] ml-1">
              Masuk
            </a>
          </span>
        </form>
